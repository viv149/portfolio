                ...
                <Row>
                    <div className="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                        <div className="about-text">
                            ...
                            <span className="mr-2">Hey Vivek, I'm</span>
                            ...
                            <div className="custom-btn-group mt-4">
                                <a href="assets/document/Frontend_V3.pdf" className="btn mr-lg-2 custom-btn"><i className='uil uil-file-alt'></i> Download Resume</a>
                    ...
                    <div className="col-lg-5 col-md-12 col-12">
                        <div className="about-image svg">
                            <Image src="assets/images/undraw/undraw_software_engineer_lvl5.svg" className="img-fluid" alt="svg image"/>
                        </div>
                    </div>
                </Row>
            </Container>
